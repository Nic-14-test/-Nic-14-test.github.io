  ...
  <section id="container" >
                      	...
                      	<div class="col-md-4 col-sm-4 mb">
                      		<div class="white-panel pn">
								...
								<div class="row">
	                      		...
	                      		<div class="centered">
										<img src="<?= ASSETS . THEME ?>admin/img/product.png" width="120">
	                      		</div>
                      		</div>
                      	</div><!-- /col-md-4 -->
      ...
      *********************************************************************************************************************************************************** -->                  
                  ...
                  <div class="col-lg-3 ds">
                    <!--COMPLETED ACTIONS DONUTS CHART-->
                      ...
                      <div class="desc">
                      	<div class="thumb">
                      		<img class="img-circle" src="<?= ASSETS . THEME ?>admin/img/ui-divya.jpg" width="35px" height="35px" align="">
                      	</div>
                      	<div class="details">
                      ...
                      <div class="desc">
                      	<div class="thumb">
                      		<img class="img-circle" src="<?= ASSETS . THEME ?>admin/img/ui-sherman.jpg" width="35px" height="35px" align="">
                      	</div>
                      	<div class="details">
                      ...
                      <div class="desc">
                      	<div class="thumb">
                      		<img class="img-circle" src="<?= ASSETS . THEME ?>admin/img/ui-danro.jpg" width="35px" height="35px" align="">
                      	</div>
                      	<div class="details">
                      ...
                      <div class="desc">
                      	<div class="thumb">
                      		<img class="img-circle" src="<?= ASSETS . THEME ?>admin/img/ui-zac.jpg" width="35px" height="35px" align="">
                      	</div>
                      	<div class="details">
                      ...
                      <div class="desc">
                      	<div class="thumb">
                      		<img class="img-circle" src="<?= ASSETS . THEME ?>admin/img/ui-sam.jpg" width="35px" height="35px" align="">
                      	</div>
                      	<div class="details">
	...
	<script type="text/javascript">
        ...
        var unique_id = $.gritter.add({
            ...
            image: '<?= ASSETS . THEME ?>admin/img/ui-sam.jpg',
