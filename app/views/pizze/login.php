					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href=""><i class="fa fa-envelope"></i> nicbird2010+monkeys_pizzeria@gmail.com</a></li>
							</ul>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="index.html"><img src="<?= ASSETS?>pizza/images/home/logo.png" alt="" /></a>
						</div>
			...
			<div class="row" style="text-align: center;" >
				<div class="col-sm-4 col-sm-offset-1" style="float: none;display: inline-block">
					<div class="login-form"><!--login form-->
						...
						<br>
                          <a href="signup">Dont have a account? Signup here</a>
					</div><!--/login form-->
				</div>
				</div>
			</div>
